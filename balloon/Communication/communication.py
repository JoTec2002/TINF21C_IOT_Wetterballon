...
class Communication:
    ...
    def send_data(self, gps_data, temp_pressure_humidity_outdoor_data):
        ...
        if return_gps == -2 or return_temp_pressure_humidity_outdoor == -2:
            # on -2 return data should not be send via LoRa
            # print("return")
            return

        if return_gps > 0 and return_temp_pressure_humidity_outdoor > 0:
